            ...
            <div class="col-12 col-lg-6 bg-red p-5 pt-0 rounded-c">
                <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <textarea name="description" id="description" cols="30" rows="5" class="form-control pt-2 f-c rounded-c"></textarea>
                        @error('description')
                            <div class="text-white ms-3">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="number" step="0.01" name="price" id="price"
                            class="form-control pt-2 f-c rounded-c">
                        @error('price')
                            <div class="text-white ms-3">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-outline">
                        <button type="submit" class="btn btn-white rounded-c d-block w-100">Создать</button>
                    </div>
                </form>
            </div>
        </div>
